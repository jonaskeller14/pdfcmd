...
parser.add_option("-o", "--open",       action="store_true",                dest="open",        help="#TODO")

# TODO Group
#TODO: argparse statt optionparser
...
def main():
    ...
    if del_src:
        ...
        for filename in filenames:
            logging.info(f"\t{filename}")
            os.remove(filename)
    # TODO: kombinationen ausschließen -> nicht seiten deleten und dann extracten
